...
@pytest.mark.parametrize("raw_title, expected, expected_failed_keys", [
    ...
    ("The Adam Project 2022 1080p VOSTFR", True, []),
    ("The Adam Project 2022 1080p VFQ", False, ["lang_fr-CA"]),
...
@pytest.mark.parametrize("raw_title, expected", [
    ...
    ("The Adam Project 2022 1080p VOSTFR", True),
    ("The Adam Project 2022 1080p VFF", False),
...
@pytest.mark.parametrize("raw_title, expected, expected_failed_key", [
    ("The Adam Project 2022 1080p VOSTFR", True, "missing_required_language"),
    ("The Adam Project 2022 1080p VFF", False, None),
...
@pytest.mark.parametrize("raw_title, expected, expected_audio", [
    ("Oppenheimer.2023.2160p.REMUX.IMAX.Dolby.Vision.And.HDR10.PLUS.ENG.ITA.LATINO.DTS-HD.Master.DDP5.1.DV.x265.mkv", False, ["Dolby Digital Plus", "DTS-HD MA"]),
